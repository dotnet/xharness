namespace Microsoft.DotNet.XHarness.iOS.Shared
{
    ...
    {
        public static string Xcode { get; private set; } = "12.5";
        public static string OSX { get; private set; } = "11.3";
        public static string iOS { get; private set; } = "14.5";
        public static string WatchOS { get; private set; } = "7.4";
        public static string TVOS { get; private set; } = "14.5";
        ...
        public static string MiniOSSimulator { get; private set; } = "11.4";
        public static string MinWatchOSSimulator { get; private set; } = "5.0";
        public static string MinWatchOSCompanionSimulator { get; private set; } = "12.0";
        public static string MinTVOSSimulator { get; private set; } = "11.4";

        public static string MaxiOSSimulator { get; private set; } = "14.5";
        public static string MaxWatchOSSimulator { get; private set; } = "7.4";
        public static string MaxWatchOSCompanionSimulator { get; private set; } = "14.5";
        public static string MaxTVOSSimulator { get; private set; } = "14.5";

        public static string MaxiOSDeploymentTarget { get; private set; } = "14.5";
        public static string MaxWatchDeploymentTarget { get; private set; } = "7.4";
        public static string MaxTVOSDeploymentTarget { get; private set; } = "14.5";
