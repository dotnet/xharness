...
internal class Simulator
{
    ...
    public Simulator(string name, string platform, string identifier, string version, string? source, string installPrefix, long fileSize, bool isCryptexDiskImage, string buildUpdate)
    {
        Name = name;
        Platform = platform;
