...
internal abstract class AndroidHeadlessCommand<TArguments> : XHarnessCommand<TArguments> where TArguments : IXHarnessCommandArguments
{
    ...
    protected AndroidHeadlessCommand(string name, bool allowsExtraArgs, string? help = null)
