...
internal class AndroidHeadlessStateCommand : GetStateCommand<AndroidHeadlessStateCommandArguments>
{
    protected override string CommandUsage { get; } = "android-headless state";

    protected override AndroidHeadlessStateCommandArguments Arguments { get; } = new();

    public AndroidHeadlessStateCommand() : base(TargetPlatform.Android, new ServiceCollection())
    {
    }
